...
import logo from "./Image/Screenshot__1262_-removebg-preview.png";
import "./style.css";
import "./search";
...
function App() {
  ...
  const API_KEY = "25371891a57c62e6ae5d894eba150721";
  ...
  window.addEventListener("scroll", function () {
    ...
    if (window.scrollY > 0) {
      ...
      header.style.backgroundColor = "#000000"; // Change the background color as needed
      header.style.padding = "10px"; // Add padding to make it look better
    } else {
      header.style.position = "relative";
      header.style.backgroundColor = "transparent"; // Reset background color
      header.style.padding = "15px"; // Reset padding
    }
  });
      ...
      <div className="App">
        <div className="header" id="header">
          <div className="container">
            <a className="nav__intro2">
              <img
                src={logo}
                alt=""
                style={{ width: "25%", transform: "translateX(-15px)" }}
                id="logoBlack"
              />
            </a>
            <ul className="main-nav">
              ...
              <li>
                <form onSubmit={fetchMovies}>
                  <div class="search" onSubmit={fetchMovies}>
                    <input
                      placeholder="Search..."
                      type="text"
                      id="search"
                ...
                {playing ? (
                  ...
                  <div className="center-max-size">
                    <div className="poster-content">
                      ...
                      <h1 className="DesApp">{movie.title}</h1>
                      <p>{movie.overview}</p>
                    </div>
                  </div>
                )}
          ...
          <div className="footer__container__box">
            <a className="nav__intro2">
              <img
                src={logo}
                alt=""
                style={{ width: "25%", transform: "translateX(-85px)" }}
                id="logoBlack"
              />
            </a>
            <div>
              <p
                class="copyright"
                style={{ transform: "translateX(-65px)", marginTop: "50px" }}
              >
                &copy; 2024 <span>WatchWise</span> All Right Reserved.
              </p>
            </div>
